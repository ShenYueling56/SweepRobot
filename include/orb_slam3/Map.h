...
#include "include/CARV/Modeler.h"
#endif
...
namespace ORB_SLAM3 {
    ...
    public:
        ...
        std::vector<KeyFrame *> GetAllOrderedKeyFrames();
        ...
        bool IsRecentInitKF(KeyFrame *pKF);

        void AddRecentInitKF(KeyFrame *pKF);

        bool HasEnoughKFs(long unsigned int curKFId);
    ...
    protected:
        ...
        std::set<KeyFrame *> msRecentInitKFs;
        ...
        long unsigned int mnLastRestartKFid;
