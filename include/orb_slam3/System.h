...
namespace ORB_SLAM3 {
    ...
    public:
        enum eLevel {
            VERBOSITY_QUIET = 0,
            VERBOSITY_SELF_DEBUG = 1,
            VERBOSITY_NORMAL = 2,
            VERBOSITY_VERBOSE = 3,
            VERBOSITY_VERY_VERBOSE = 4,
            VERBOSITY_DEBUG = 5
        };
    ...
    public:
        static void PrintMess(std::string str, eLevel lev, bool bEndl = true) {
            if (lev <= th && bEndl)
                cout << str << endl;
            else if (lev <= th && !bEndl)
                cout << str;
        }
    ...
    public:
        ...
        System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor,
               ...
               const string &strLoadingFile = std::string(), const bool &bCreateVoc = false);
        ...
        cv::Mat TrackStereo(const cv::Mat &imLeft, const cv::Mat &imRight, const double &timestamp,
                            ...
                            const vector<ODO::Point> &vOdoMeas = vector<ODO::Point>(), string filename = "");
        ...
        void SaveMapPCD(const string &filename);
        ...
        void SaveTime(std::string save_path);
        ...
        ofstream mfDebugForOdo;

        void GetCurPose(cv::Mat &Tcw);
