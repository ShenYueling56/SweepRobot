...
#include "include/orb_slam3/TwoViewReconstruction.h"
...
namespace ORB_SLAM3 {
    ...
    bool
    TwoViewReconstruction::Reconstruct(const std::vector<cv::KeyPoint> &vKeys1, const std::vector<cv::KeyPoint> &vKeys2,
