...
namespace ORB_SLAM3 {
    ...
    int ORBmatcher::SearchByBoW(KeyFrame *pKF, Frame &F, vector<MapPoint *> &vpMapPointMatches) {
        ...
        const FeatVec &vFeatVecKF = pKF->mFeatVec;
        ...
        FeatVec::const_iterator KFit = vFeatVecKF.begin();
        FeatVec::const_iterator Fit = F.mFeatVec.begin();
        FeatVec::const_iterator KFend = vFeatVecKF.end();
        FeatVec::const_iterator Fend = F.mFeatVec.end();
    ...
    int ORBmatcher::SearchByBoW(KeyFrame *pKF1, KeyFrame *pKF2, vector<MapPoint *> &vpMatches12) {
        ...
        const FeatVec &vFeatVec1 = pKF1->mFeatVec;
        const vector<MapPoint *> vpMapPoints1 = pKF1->GetMapPointMatches();
        const cv::Mat &Descriptors1 = pKF1->mDescriptors;

        const vector<cv::KeyPoint> &vKeysUn2 = pKF2->mvKeysUn;
        const FeatVec &vFeatVec2 = pKF2->mFeatVec;
        ...
        FeatVec::const_iterator f1it = vFeatVec1.begin();
        FeatVec::const_iterator f2it = vFeatVec2.begin();
        FeatVec::const_iterator f1end = vFeatVec1.end();
        FeatVec::const_iterator f2end = vFeatVec2.end();
                ...
                for (size_t i1 = 0, iend1 = f1it->second.size(); i1 < iend1; i1++) {
                    ...
                    for (size_t i2 = 0, iend2 = f2it->second.size(); i2 < iend2; i2++) {
                        ...
                        if (pCamera1->epipolarConstrain(pCamera2, kp1, kp2, R12, t12, pKF1->mvLevelSigma2[kp1.octave],
                                                        pKF2->mvLevelSigma2[kp2.octave]) || bCoarse) // MODIFICATION_2
                        {
                            bestIdx2 = idx2;
                            bestDist = dist;
                        }
            ...
            if (pMP) {
                if (!LastFrame.mvbOutlier[i]) {
                    ...
                    if (bForward)
                        ...
                        vIndices2 = CurrentFrame.GetFeaturesInArea(uv.x, uv.y, radius, nLastOctave - 1,
                                                                   nLastOctave + 1);
                    ...
                    if (CurrentFrame.Nleft != -1) {
                        cv::Mat x3Dr =
                                CurrentFrame.mTrl.colRange(0, 3).rowRange(0, 3) * x3Dc + CurrentFrame.mTrl.col(3);
