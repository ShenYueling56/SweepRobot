...
//BOOST_CLASS_EXPORT_GUID(KannalaBrandt8, "KannalaBrandt8")
    ...
    float
    KannalaBrandt8::TriangulateMatches(GeometricCamera *pCamera2, const cv::KeyPoint &kp1, const cv::KeyPoint &kp2,
    ...
    void
    KannalaBrandt8::Triangulate(const cv::Point2f &p1, const cv::Point2f &p2, const cv::Mat &Tcw1, const cv::Mat &Tcw2,
                                cv::Mat &x3D) {
        cv::Mat A(4, 4, CV_32F);
